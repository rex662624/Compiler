...
static const yytype_uint16 yyrline[] =
{
     ...
     524,   529,   537,   564,   591,   617,   648,   674,   705,   751,
     806,   857,   903,   949,   975,   988,  1010,  1011,  1012,  1015,
    1031,  1039,  1047,  1075
};
#endif
...
#line 416 "compiler_hw3.y" /* yacc.c:1646  */
    {
						...
						CheckUndefined = 0;
						if(ret==-1)
							{printf("<ERROR>:Undefined variable %s (line %d)\n",(yyvsp[-1].string),linecount);ERROR=1;}
						else{
								if(strcmp(table[ret]->type,"float32")==0){
								insert_value(ret,(table[ret]->f_val)+1,0);
								//id+1;
...
#line 494 "compiler_hw3.y" /* yacc.c:1646  */
    {				
							...
							CheckUndefined = 0;
							if(ret==-1)
								{printf("<ERROR>:Undefined variable %s (line %d)\n",(yyvsp[0].string),linecount);ERROR=1;}
							else{
								if(strcmp(table[ret]->type,"float32")==0)
								{
...
#line 2074 "y.tab.c" /* yacc.c:1646  */
  ...
  case 45:
#line 617 "compiler_hw3.y" /* yacc.c:1646  */
    {//<=
							sprintf((yyval.val).buf,"%s","");//先清空
							int ret;
							if((yyvsp[-2].val).type==1&&(yyvsp[0].val).type==1)
...
#line 2545 "y.tab.c" /* yacc.c:1646  */
  ...
  case 60:
#line 1031 "compiler_hw3.y" /* yacc.c:1646  */
    {
...
#line 2571 "y.tab.c" /* yacc.c:1646  */
  ...
  case 62:
#line 1048 "compiler_hw3.y" /* yacc.c:1646  */
    {	
...
#line 1105 "compiler_hw3.y" /* yacc.c:1906  */
